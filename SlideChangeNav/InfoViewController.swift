...
typealias InfoBlock = (infoBlock:Bool)->Void
...
class InfoViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    func createTabView(){
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(InfoViewController.notiAction(_:)), name: "turorSwift", object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(InfoViewController.notiAction(_:)), name: "BlessSwift", object: nil)
    ...
    func scrollViewDidEndDecelerating(scrollView: UIScrollView) {
        ...
        NSNotificationCenter.defaultCenter().postNotificationName("infoSwift", object: nil, userInfo: dic)
...
class TeachHomePageMoreView: UIView {
